...
import com.cupay.api.test.UnitTestActivity;
import com.cupay.api.test.ColorTestUtils;
...
public class EnrollmentCardViewUnitTest {
    ...
    public void setup_correctIconBasedOnBackground() {
        AppCompatActivity darkActivity = ColorTestUtils.setupActivity(R.color.bt_black);
        mView.setup(darkActivity);
        assertDrawableIsFromResource(R.id.bt_sms_code_icon, R.drawable.bt_ic_sms_code_dark);

        AppCompatActivity lightActivity = ColorTestUtils.setupActivity(R.color.bt_white);
