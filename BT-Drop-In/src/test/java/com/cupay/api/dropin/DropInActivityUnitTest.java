...
import static com.cupay.api.dropin.DropInActivity.ADD_CARD_REQUEST_CODE;
import static com.cupay.api.dropin.DropInActivity.DELETE_PAYMENT_METHOD_NONCE_CODE;
import static com.cupay.api.dropin.DropInActivity.EXTRA_PAYMENT_METHOD_NONCES;
import static com.cupay.api.dropin.DropInRequest.EXTRA_CHECKOUT_REQUEST;
import static com.cupay.api.test.PackageManagerUtils.mockPackageManagerSupportsThreeDSecure;
...
import static com.cupay.api.test.UnitTestFixturesHelper.base64EncodedClientTokenFromFixture;
...
public class DropInActivityUnitTest {
    ...
    public void onPaymentMethodNoncesUpdated_showsNothingIfNoVaultedPaymentMethods() {
        ...
        assertThat((RecyclerView)mActivity.findViewById(R.id.bt_vaulted_payment_methods)).isNotShown();
